...
import io.renren.modules.management.dao.OrderDefectiveListDao;
...
@Service("orderDefectiveListService")
public class OrderDefectiveListServiceImpl extends ServiceImpl<OrderDefectiveListDao, OrderDefectiveEntity> implements OrderDefectiveListService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        List<OrderDefectiveEntity> orderDefective = this.baseMapper.selectOrderDefectiveList(
				page,
        		entityMap);
